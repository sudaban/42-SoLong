...
SRC =	so_long.c src/allocation/allocation.c src/allocation/safe_exit.c \
		...
		src/key_events/handle_keys.c src/key_events/move_helpers.c \
		src/map_operations/map_flood.c src/map_operations/map_parse.c src/map_operations/map_split.c
